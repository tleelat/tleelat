...
🎓 MS Analytics @ San Francisco State University, GPA: 3.97/4.00  
💡 3+ years building scalable AI/ML & Data Analytics solutions for global organizations  
🏆 AWS Certified | NLP, MLOps, Machine Learning, GenAI, Cloud Infrastructure, ETL, Distributed Systems, Data Analytics. 
...
- **Languages & Frameworks:**  
  Python (FastAPI), Java (Spring Boot, REST API), JavaScript (Node.js, React.js), PySpark, PyTorch, Pandas, NumPy, Scikit-learn

- **Databases:**  
  MySQL, PostgreSQL, MongoDB, Redis, ChromaDB, Pinecone

- **DevOps & Cloud:**  
  Docker, Kubernetes, Terraform, Git, GitHub Actions, AWS (S3, EMR, Glue, Bedrock, SageMaker), GCP (BigQuery, VertexAI), Azure (AISearch, Synapse, BlobStorage), Prometheus, Grafana

- **Data Engineering:**  
  Airflow, Spark, Kafka, Snowflake, dbt, BigQuery, MLflow, Kubeflow

- **Machine Learning:**  
  Regression, Classification, Neural Networks, XGBoost, NLP, Deep Learning, Fine Tuning, TensorFlow, Keras, A/B Testing, Causal Inference

- **Generative AI:**  
  HuggingFace Transformers, GPT, LLM, RAG, Prompt Engineering, LangChain, LangGraph, LangFuse, CrewAI, MCP, Agentic workflows, OpenAI, VertexAI
...
<a href="https://github.com/tleelat/SleepEfficiency">
  <img src="https://img.shields.io/badge/SleepEfficiency-AI-blue?style=for-the-badge" />
</a>
<a href="https://github.com/tleelat/dietaryTracking">
  <img src="https://img.shields.io/badge/DietaryTracking-ML-green?style=for-the-badge" />
</a>
<a href="https://github.com/tleelat/etfmodel">
  <img src="https://img.shields.io/badge/ETFModel-Finance-orange?style=for-the-badge" />
</a>
<a href="https://github.com/tleelat/breastCancerPrediction">
  <img src="https://img.shields.io/badge/BreastCancerPrediction-Healthcare-pink?style=for-the-badge" />
</a>
